...
/// الصفحة تقرأ عدادات الغياب وتصنيف الأيام من رد الخادم.
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            if (ready)
              _LastSyncBanner(sync: result.lastSync, rangeTo: result.range.to),
...
class _Stats {
  ...
  static _Stats of(TimesheetSummary summary) {
    return _Stats(
      workDays: summary.workDays,
      present: summary.presentFullDays,
      leave: summary.leaveDays,
      absence: summary.absenceDays,
      gateAbsence: summary.gateAbsenceDays,
      totalAbsence: summary.totalAbsenceDays,
      gateViolations: summary.carViolations,
      leakMinutes: summary.totalLeakMinutes,
      unknown: 0,
    );
  }
}
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final meta = [
      ?workplace,
      if (carNumber != null) 'لوحة $carNumber',
    ].join(' · ');
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: color.withValues(alpha: stale ? 0.6 : 0.35),
          width: stale ? 1.4 : 1,
        ),
      ),
      child: Row(
...
class _DayCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final showGate =
        car.hasData || car.leakMinutes > 0 || car.exemption?.isReal == true;
    ...
    final card = AppSurface(
      ...
      child: Column(
        ...
        children: [
          ...
          if (showGate) ...[const SizedBox(height: 10), _GateStrip(car: car)],
        ],
      ),
    );
...
class _GateStrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final violation =
        ...
        (tone == StatusTone.warning && judgment.code == 4);
